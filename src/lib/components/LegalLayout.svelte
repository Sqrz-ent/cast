...
<style>
  ...
  :global(.legal-page .last-updated) {
    font-size: 0.75rem;
  ...
  :global(.legal-page ul li::before) {
    content: '→';
    position: absolute;
    left: 0;
    color: var(--accent);
  ...
  :global(.legal-page a:hover) { border-color: var(--accent); }

  :global(.legal-page hr) {
    border: none;
